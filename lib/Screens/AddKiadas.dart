...
class AddOrUpdateKiadasState extends State<AddOrUpdateKiadas> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(title: Text('Kiadás hozzáadása/módosítása')),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(
                  children: [
                    Text('${AppLocalizations.of(context)!.date}:', style: TextStyle(fontSize: 15)),
                    SizedBox(height: 20,),
                    SizedBox(
                      height: 35,
                      width: 250,
                ...
                Row(
                  ...
                  children: <Widget> [
                    Text("${AppLocalizations.of(context)!.place}:${controllerPlace.text}", style: TextStyle(fontSize: 18)),
                    SizedBox(width: 20),
                    Expanded(
                        child: Text("$place")
                    )
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: <Widget> [
                    Text("${AppLocalizations.of(context)!.expenditure}:", style: TextStyle(fontSize: 18)),
                    SizedBox(width: 20),
                    Expanded(
                        child: TextField(
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: <Widget> [
                    Text("${AppLocalizations.of(context)!.withwho}:${controllerKivel.text}", style: TextStyle(fontSize: 18)),
                    SizedBox(width: 20),
                    Expanded(
                      child: Text("$name")
                    ),
                ...
                RaisedButton(
                  child: Text("${AppLocalizations.of(context)!.contactlist}"),
                  onPressed: () {
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    Text("${AppLocalizations.of(context)!.receipt}:", style: TextStyle(fontSize: 18)),
                    SizedBox(width: 20),
                    RaisedButton(
                      child: Text("${AppLocalizations.of(context)!.camera}"),
                      onPressed: (){
                        Navigator.push(context, MaterialPageRoute(builder: (_)=> TakeNyugtaPicture(camera: camera)));
                      },
                    ),
                  ],
                ),
                ...
                MaterialButton(
                  ...
                  onPressed: () async {
                    ...
                    if(getDate.isNotEmpty & getPlace.isNotEmpty & getPrice.isNotEmpty & getKivel.isNotEmpty){
                      Kiadasok kiadasokdata = new Kiadasok(date: getDate, place: getPlace, price: getPrice, kivel: getKivel, image_path: getImagePath);
                      if(widget.isEdit){
                        var box = await Hive.openBox<Kiadasok>('kiadasok');
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (_) => KiadasokListScreen()));
                    }
                  },
                ),
              ],
